...
if __name__ == "__main__":
    # 输入文件路径
    input_file = "蛊真人_处理后.epub"  # 处理后的EPUB文件路径
    output_file = "蛊真人_处理后_再次删除.epub"  # 输出EPUB文件路径

    # 指定需要删除的章节文件名
    chapters_to_remove = [
        "Text/Chapter0865.xhtml",  # 第二百一十一节卡文无更
        "Text/Chapter1239.xhtml",  # 第二百一十一节卡文无更
        "Text/Chapter1439.xhtml",  # 第四百一十一节卡文无更
        "Text/Chapter1539.xhtml",  # 第五百一十一节无更
        "Text/Chapter1639.xhtml",  # 第六百一十一节无更
        "Text/Chapter1705.xhtml",  # 第六百七十七节无更
        "Text/Chapter1839.xhtml"   # 第八百一十一节无更
    ]
